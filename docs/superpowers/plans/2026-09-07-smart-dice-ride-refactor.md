...
- [x] **Step: 真机冒烟清单（dev 手测）**

> 2026-09-08 由 Playwright 机器人代为冒烟（420×900 + 假 GPS 沣镇 108.85,34.10）：
> 1. 80km·爬坡·南山：出 3 候选，79.9km · 436min · ↗1208m，信任徽章「人工精校」；
> 2. 全站四页（Explore/Preset/Travel/结果）0 pageerror、图标全部解析、无 emoji 残留；
> 3. 20-30km 在南山池仍走经典兜底（首批廊道缺 3-5km 小段，属 P2 范围）。
> 说明：GPX 外部比对与真机手感仍需人工，未覆盖。
