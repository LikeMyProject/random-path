...
// 购物补充坑：高德 060100/060800 类型码检索会返回「文具店/书店/美术用品/批发市场/农产品」等
// 非商场 POI（名字里没"商场"二字但被归到购物类型下），必须显式挡掉，否则购物清单混入文具店。
const NOISE_POI = /收费站|服务区|停车场|公交站|地铁站$|配送点|快递|物流|驾校|汽修|洗车|维修|菜市场|农贸市场|酒店$|宾馆$|公寓$|客房$|度假村$|售票处|游客中心|服务中心|咨询处|内广场|入口$|东门$|西门$|南门$|北门$|正门$|健身|训练馆|健身房|游泳馆|瑜伽|球馆|台球|网吧|KTV|酒吧|洗浴|按摩|美甲|美容|理发|超市|便利店|药店|医院|诊所|学院|学校|中学|小学|工厂|工业园|产业园|4S店|俱乐部|鸡尾酒|夜店|酒馆|餐吧|精酿|livehouse|微醺|小酒馆|体验店|专卖店|旗舰店|文具|文具店|晨光|宣纸|美术用品|书画|字画|书店|书城|文创|批发|批发市场|农产品|农贸|果品|果蔬|水果批发|物流中心|物流园|酒店用品|小商品|美食城|美食街|客栈|民宿|旅舍|青旅|小筑|精品客栈|家庭民宿|土特产|特产|大院|如家|汉庭|七天|7天|全季|亚朵|锦江|维也纳|城市便捷|尚客优|布丁|速8|速八|宜必思|温德姆|豪生/
...
async function collectCat(cat, pool, target, cityName) {
  ...
  const add = it => {
    ...
    // 美食类：高德多个泛关键词（夜市/美食街/小吃街/夜市街）会返回同一美食街的命名变体
    // （如「永兴坊」与「永兴坊·陕西非遗美食文化街区」仅隔 5 米），或把周边民宿/客栈/特产店也捞进来；
    // name|address 精确去重挡不住名字微调的变体，故坐标 <400m 同 category 视为同一处合并（保留先到的）。
    if (cat === 'food' && local.some(o => haversineKm(o.coord, it.coord) < 0.4)) return false
